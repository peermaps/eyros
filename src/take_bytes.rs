...
take_bytes![u8,u16,u32,u64,u128,i8,i16,i32,i64,i128,f32,f64,char];
...
tuple_take_bytes![A,B];
tuple_take_bytes![A,B,C];
tuple_take_bytes![A,B,C,D];
tuple_take_bytes![A,B,C,D,E];
tuple_take_bytes![A,B,C,D,E,F];
tuple_take_bytes![A,B,C,D,E,F,G];
tuple_take_bytes![A,B,C,D,E,F,G,H];
tuple_take_bytes![A,B,C,D,E,F,G,H,I];
tuple_take_bytes![A,B,C,D,E,F,G,H,I,J];
...
macro_rules! comb_array_size_of {
  (($i:expr)) => {
    array_size_of![$i];
  };
  (($i:expr,$($n:expr),*)) => {
    array_size_of![$i];
    comb_array_size_of![($($n),*)];
  };
}
comb_array_size_of![(
